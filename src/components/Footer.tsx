...
export default function Footer() {
  const socials = [
    {
      icon: faFacebookF,
      link: "https://www.facebook.com/snigdha.chandra.paik",
    },
    {
      icon: faInstagram,
      link: "https://www.instagram.com/snigdha_chandra_paik/",
    },
  ...
  return (
    <footer className="bg-[#141B1A] text-[#F7F3E9] px-6 md:px-16 py-24 border-t border-[#F7F3E9]/5">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-16 md:gap-8 items-start md:items-center">
          ...
          <div className="flex flex-col gap-6">
            <p className="text-[10px] uppercase tracking-[0.4em] text-[#F7F3E9]/20 font-bold">
              Inquiries
            </p>
            <div className="flex flex-col gap-5">
              <a
                href="mailto:snigdhachandrapaik@gmail.com"
                className="group flex items-center gap-4 text-sm hover:text-[#C58473] transition-all duration-500"
              >
                <div className="w-9 h-9 rounded-full border border-[#F7F3E9]/10 flex items-center justify-center group-hover:border-[#C58473]/50 transition-colors">
                  <FontAwesomeIcon
                    icon={faEnvelope}
                    className="text-[#C58473] text-xs"
                  />
                </div>
                <span className="tracking-wide opacity-70 group-hover:opacity-100">
                  Email Me
                </span>
              </a>
              <a
                href="tel:+918391879168"
                className="group flex items-center gap-4 text-sm hover:text-[#C58473] transition-all duration-500"
              >
                <div className="w-9 h-9 rounded-full border border-[#F7F3E9]/10 flex items-center justify-center group-hover:border-[#C58473]/50 transition-colors">
                  <FontAwesomeIcon
